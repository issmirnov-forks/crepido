...
app.get('/board\*', function(request, response){
    ...
    fs.readFile(reqpath, 'utf8', function (err,data) {
        ...
        for (var i = 0; i < rendered.length; i++) {
            ...
            html += '<div class="board"><div class="board__header"><a href="' + rendered[i].head.picture + '" class="board__picture"><img src="' + rendered[i].head.picture + '"></a><h2 class="board__name">' + rendered[i].head.name + '</h2></div>' + rendered[i].body + '</div>';
        }
        html = '<html><head><title>' + title.join(" | ") + '</title><meta name="viewport" content="width=device-width, initial-scale=1"><link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/font-awesome/4.3.0/css/font-awesome.min.css"><link rel="stylesheet" href="/assets/stylesheets/style.css"></head><body><div class="crepido">' + html + '</div></body></html>';
...
app.get('/\*', function(request, response){
    ...
    if(request.path === "/"){
        var html = '<div class="board"><div class="board__header"><h2 class="board__name">All boards</h2></div><div class="board__card board__card--headers"><h1>Boards</h1><ul>';
        ...
        html = '<html><head><title>Boards</title><meta name="viewport" content="width=device-width, initial-scale=1"><link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/font-awesome/4.3.0/css/font-awesome.min.css"><link rel="stylesheet" href="/assets/stylesheets/style.css"></head><body><div class="crepido">' + html + '</ul></div></div></div></body></html>';
